    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('professional', 'Professional'), ('patient', 'Patient')], max_length=12, verbose_name='Account Type')),
                ...
                ('dietary_restrictions', models.TextField(blank=True, null=True, verbose_name='Dietary Restrictions')),
